    ...
    private val machineryListState = MutableStateFlow<List<Machinery>>(
        listOf(
            Machinery(
                ...
                imageUrls = listOf("seeder_main_1", "seeder_main_2", "seeder_main_3", "seeder_main_4"),
                rating = 4.9,
                acresDone = 186.0,
            ...
            Machinery(
                ...
                isAvailable = true,
                status = MachineryStatus.APPROVED,
                imageUrls = listOf("seeder_main_2", "seeder_main_3", "seeder_main_4"),
                rating = 4.7,
                acresDone = 142.0,
            ...
            Machinery(
                ...
                isAvailable = true,
                status = MachineryStatus.APPROVED,
                imageUrls = listOf("seeder_main_3", "seeder_main_4", "seeder_main_1"),
                rating = 5.0,
                acresDone = 219.0,
